    ...
    <section id="experience" className="py-16 px-6 sm:px-8 lg:px-12">
      <div className="max-w-4xl">
        <div className="mb-12">
          ...
          <p className="text-slate-600">2.6 years of hands-on experience in software development</p>
        </div>
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                  ...
                  <div className="flex flex-col gap-2 text-blue-50">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="bg-white/20 px-2 py-0.5 rounded text-sm">{exp.duration}</span>
                    </div>
                    <div className="flex items-center gap-2">
                ...
                <div className="mb-6">
                  ...
                  <ul className="space-y-2">
                    {exp.achievements.map((achievement, achIdx) => (
                      <li key={achIdx} className="flex items-start gap-2 text-slate-700">
